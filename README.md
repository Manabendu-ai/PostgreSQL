...
Here the basic topics such as How to create a database, drop a database, create a table, drop a table, datatypes, inserting data into table and a basic select query
